...
class BookListingInterface:
    ...
    def addEntry(self):
        ...
        try:
            ...
            bookID = int(input("Enter book ID: ").strip())
            bookPublisher = input("Enter publisher: ").strip()
            bookAuthor = input("Enter author: ").strip()
            bookGenre = input("Enter genre: ").strip()
            newBook = BookListing(bookTitle, bookID, bookPublisher, bookAuthor, bookGenre)

            new_book = BookListing(bookTitle,bookID,bookPublisher,bookAuthor,bookGenre)
            self.bookCatalog.append(newBook)
            print(f"Book {bookTitle} has been added successfully.")
        except ValueError:
        ...
        try:    
            ...
            for book in self.bookCatalog:
                if book.getBookID() == bookID:
                    ...
                    print(f"Book {book.getTitle()} has been removed successfully.")
                    return
            print("Book not found.")
        except ValueError:
            print("Invalid input.Book ID must be a number.")
    ...
    def displayBookListMenu(self):
        while True:
            print("\n-----Book List Menu -----")
            print("1. View All Books")
            print("2. Search for a Book By Title")
            print("3. Add a New Book Title")
            print("4. Delete a Book Entry")
            print("5. Update Book Entry")
        ...
        while True:
            try:
                ...
                if loginChoice == 1:
                    ...
                    user = self.authenticateLogin(user_name, password) # pass username and password to the authenticate function to make sure user is available and add password
                    if user:
        ...
        while True:
            try:
                ...
                if choice == 1:
                    ...
                    print("Invalid Entry. Please enter an integer between 1-2.")
            except ValueError:
                print("Invalid Entry. Please enter an integer between 1-2.")
...
class UserAccountManager:
    def __init__(self):
        ...
        } # create a dictionary to store the users information
